        ...
        { uiMode === "admin" ? (
          <AdminPage>
            <AdminPanel
              ...
              loadAdminTransactions={loadAdminTransactions}
              adminUnlockUsername={adminUnlockUsername}
              adminTab={adminTab}
              setAdminTab={setAdminTab}
              memberCreditEnabled={memberCreditEnabled}
              adminTotals={adminTotals}
              hasActiveFilters={hasActiveFilters}
              lockAdminPanel={lockAdminPanel}
              downloadAdminCsv={downloadAdminCsv}
              adminFilteredTransactions={adminFilteredTransactions}
              adminStatusFilter={adminStatusFilter}
              onAdminStatusFilterChange={(value) =>
                setAdminStatusFilter(value as "all" | TransactionStatus)
              }
              adminProductFilter={adminProductFilter}
              setAdminProductFilter={setAdminProductFilter}
              adminProductOptions={adminProductOptions}
              adminItemQuery={adminItemQuery}
              setAdminItemQuery={setAdminItemQuery}
              ...
              buildCartBreakdownJson={buildCartBreakdownJson}
              stockSnapshot={stockSnapshot}
              stockProductQuery={stockProductQuery}
              setStockProductQuery={setStockProductQuery}
              stockCurrentValueFilter={stockCurrentValueFilter}
              setStockCurrentValueFilter={setStockCurrentValueFilter}
              downloadFilteredStockEventsCsv={downloadFilteredStockEventsCsv}
              filteredStockEvents={filteredStockEvents}
              downloadFilteredStockCountsCsv={downloadFilteredStockCountsCsv}
              filteredStockItems={filteredStockItems}
              stockDraftByProductId={stockDraftByProductId}
              ...
              loadAdminCustomers={loadAdminCustomers}
              adminSessionPassword={adminSessionPassword}
              selectedAdminMember={selectedAdminMember}
              adminMemberName={adminMemberName}
              setAdminMemberName={setAdminMemberName}
              adminCustomerType={adminCustomerType}
              setAdminCustomerType={setAdminCustomerType}
              adminMemberPin={adminMemberPin}
              setAdminMemberPin={setAdminMemberPin}
              createAdminMember={createAdminMember}
              toggleSelectedMemberActive={toggleSelectedMemberActive}
              memberTopupAmount={memberTopupAmount}
              setMemberTopupAmount={setMemberTopupAmount}
              memberTopupNote={memberTopupNote}
              setMemberTopupNote={setMemberTopupNote}
              topupSelectedMember={topupSelectedMember}
              creditLedger={creditLedger}
              adminCreditEvents={adminCreditEvents}
